...
pass_through1_layer make_pass_through1_layer(int batch, int n, int w, int h, int c, int *input_layers, int *input_sizes)
{
    fprintf(stderr," pass_through1:      no.");

    pass_through1_layer l = {0};
    l.type = PASS_THROUGH1;
    l.batch = batch;
    l.n = n;
    ...
    l.forward = forward_pass_through1_layer;
    l.backward = backward_pass_through1_layer;
    #ifdef GPU
    l.forward_gpu = forward_pass_through1_layer_gpu;
    l.backward_gpu = backward_pass_through1_layer_gpu;
