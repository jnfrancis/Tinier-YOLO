...
pass_through2_layer make_pass_through2_layer(int batch, int n, int w, int h, int c, int *input_layers, int *input_sizes)
{
    fprintf(stderr," pass_through2:      no.");
    pass_through2_layer l = {0};
    l.type = PASS_THROUGH2;
    l.batch = batch;
    l.n = n;
    ...
    fprintf(stderr,"%d", input_layers[0]);
    ...
    l.forward = forward_pass_through2_layer;
    l.backward = backward_pass_through2_layer;
    #ifdef GPU
    l.forward_gpu = forward_pass_through2_layer_gpu;
    l.backward_gpu = backward_pass_through2_layer_gpu;
