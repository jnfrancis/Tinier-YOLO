...
get_squeeze_layer make_get_squeeze_layer(int batch, int n, int w, int h, int c, int *input_layers, int *input_sizes)
{
    fprintf(stderr,"fire layer: get_squeeze:      no.");
    get_squeeze_layer l = {0};
    l.type = GET_SQUEEZE;
    l.batch = batch;
    l.n = n;
    ...
    l.forward = forward_get_squeeze_layer;
    l.backward = backward_get_squeeze_layer;
    #ifdef GPU
    l.forward_gpu = forward_get_squeeze_layer_gpu;
    l.backward_gpu = backward_get_squeeze_layer_gpu;
