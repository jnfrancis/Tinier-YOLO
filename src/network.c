    ...
    switch(a){
       ...
       case MERGE_EXPAND:
        ...
        case DENSE:
            return "dense";
        case PASS_THROUGH0:
            return "pass_through0";
        case PASS_THROUGH1:
            return "pass_through1";
        case PASS_THROUGH2:
            return "pass_through2";
        case PASS_THROUGH3:
            return "pass_through3";
        default:
            break;
    }
    return "none";
...
int resize_network(network *net, int w, int h)
{
    ...
    for (i = 0; i < net->n; ++i){
        ...
        }else if(l.type == MERGE_EXPAND){
            resize_merge_expand_layer(&l, inputs);
        }else if(l.type == GET_SQUEEZE){
            resize_get_squeeze_layer(&l, inputs);
        }else if(l.type == DENSE){
            resize_dense_layer(&l, inputs);
        }else if(l.type == PASS_THROUGH0){
            resize_pass_through0_layer(&l, inputs);
        }else if(l.type == PASS_THROUGH1){
            resize_pass_through1_layer(&l, inputs);
        }else if(l.type == PASS_THROUGH2){
            resize_pass_through2_layer(&l, inputs);
        }else if(l.type == PASS_THROUGH3){
            resize_pass_through3_layer(&l, inputs);
        }else{
