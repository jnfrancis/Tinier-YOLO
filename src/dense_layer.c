...
dense_layer make_dense_layer(int batch, int n, int w, int h, int c, int *input_layers, int *input_sizes)
{
    fprintf(stderr,"dense layer   ");
    dense_layer l = {0};
    l.type = DENSE;
    l.batch = batch;
    l.n = n;
    ...
    //outputs += input_sizes[2];
    //outputs += input_sizes[3];
    //outputs += input_sizes[4];
    //outputs += input_sizes[5];
    ...
    l.forward = forward_dense_layer;
    l.backward = backward_dense_layer;
    #ifdef GPU
    l.forward_gpu = forward_dense_layer_gpu;
    l.backward_gpu = backward_dense_layer_gpu;
